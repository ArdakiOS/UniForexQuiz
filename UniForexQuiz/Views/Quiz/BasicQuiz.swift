    ...
    var body: some View {
        if !showQuiz{
            VStack{
                ...
                Text("The basic test includes 3 levels of 5 questions, answer everything correctly, and you will be able to completely fill out the progress scale!")
                    .font(.system(size: 16))
                    .fontWeight(.semibold)
                    .frame(width: 343, alignment: .leading)
                    .padding(.bottom)
            ...
            BasicQuestionPage(vm: vm, showQuiz: $showQuiz)
        }
    }
}
